export default class HolbertonCourse {
  ...
  get name() {
    // Getter for name attribute (string)
    return this._name;
  }

  get length() {
    // Getter for length attribute (number)
    return this._length;
  }

  get students() {
    // Getter for students attribute (array of strings)
